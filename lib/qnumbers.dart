...
class Qnumbers extends StatefulWidget {
  const Qnumbers({Key? key}) : super(key: key);
...
class _QuizPageState extends State<Qnumbers> {
  int _currentIndex = 0;
  int? _selectedIndex;
        ...
        return GestureDetector(
          onTap: () {
            ...
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (_) => const Qeasy()));
          },
          child: Material(
