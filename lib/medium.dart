...
class _QuizPageState extends State<MediumPage> {
  ...
  final List<Question> _allQuestions = [
    ...
    Question(
        ...
        options: [
          'San-o ko makit-an ang tubig?',
          'Diin ko makakita sang tubig?',
          'Pila ang tubig?'
        ],
    ...
    Question(
        ...
        options: [
          'Dali ka maghambal?',
          'Pwede ka kahambal hinay?',
          'Maghambal ka sing maayo?'
        ],
        correct: 'Pwede ka kahambal hinay?'),
    Question(
        phrase: 'I am looking for the market',
        options: [
          'Gina pangita ko ang merkado',
          'Ginahalinan ko ang merkado',
          'Ara ko sa merkado'
        ],
    ...
    Question(
        ...
        options: [
          'Kinahanglan ko bulig subong',
          'Magabulig ako sa imo',
          'Buligi ko anay'
        ],
    ...
    Question(
        ...
        options: [
          'Tawgan taka bwas',
          'Tawgon ta ikaw subong',
          'Ginatawag ta ikaw kada adlaw'
        ],
    ...
    Question(
        ...
        options: [
          'Makita ta ikaw didto.',
          'Kitaay ta didto',
          'Makita ko ikaw karon.',
        ],
    ...
    Question(
        ...
        options: [
          'Nalimtan ko ang pitaka ko',
          'Nabilin ang pitaka ko',
          'Nadula ang pitaka ko',
        ],
        correct: 'Nalimtan ko ang pitaka ko'),
    Question(
        phrase: 'Can you help me with this?',
        options: [
          'Palihog, buligi ko ini.',
          'Mahimo mo ko buligan sini?',
          'Pwede mo ni?'
        ],
    ...
    Question(
        ...
        options: [
          'Diin ko mabakal tiket?',
          'San-o ko mabakal tiket?',
          'Diin may ara tiket?',
        ],
    ...
    Question(
        ...
        options: [
          'Magaadto ako sa merkado',
          'Makadto ako sa tyangge',
          'Ara ko sa tindahan',
        ],
    ...
    Question(
        ...
        options: [
          'Layo pa ang merkado?',
          'Diin ang merkado?',
          'Ano kadugay ang merkado?',
        ],
        correct: 'Layo pa ang merkado?'),
    Question(
        phrase: 'I need to charge my phone.',
        options: [
          'Indi na ako makagamit phone',
          'Kinahanglan ko i-charge ang Cellphone ko',
          'Gusto ko mag-charge'
        ],
    ...
    Question(
        ...
        options: [
          'Ipakita mo sa akon.',
          'Pwede mo ipakita sa akon ang dalan?',
          'Diin ang dalan?'
        ],
