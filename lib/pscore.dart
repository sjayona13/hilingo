...
class PscorePage extends StatefulWidget {
  ...
  const PscorePage({Key? key, required this.score, required this.total}) : super(key: key);

  @override
  State< PscorePage> createState() => _EscorePageState();
}

class _EscorePageState extends State< PscorePage> with SingleTickerProviderStateMixin {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(builder: (_) => const PictureLearningPage()),
                        (route) => false,
                      );
                    },
